<%-- 
    Document   : CheckOut
    Created on : 6 Apr, 2018, 8:38:01 PM
    Author     : mohnish
--%>
            ...
            <form class="form-horizontal" role="form">
                <div class="w-75 col-lg-8 offset-lg-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" id="numb" placeholder="Give the Book Id" class="form-control" autofocus>
                            <p id="demo"></p>
                            <script>
                                function myFunction() {
                                    var x, text;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" id="bookName" placeholder="Give the Book Name" class="form-control" autofocus>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="bookName" class="col-sm-3 control-label">Date</label>
                        <div class="col-sm-9">
                            <input type="text" id="startDate" name="startDate" onblur="setExpDate(this.value)" placeholder="Give the Date" class="form-control" autofocus disabled>
                        </div>
                    </div>
